                    ...
                    <form id="form_logo" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="text-center">
                                <img id="logoEmpresa2" class="profile-user-img img-fluid img-circle">
                            </div>
                            <div class="input-group mb-3 mt-2">
                                <input type="file" name="logo" class='input-group' accept="image/*">
                                <input type="hidden" name="funcion" value="changeLogo">
                                <input type="hidden" name="id_empresa" value="<?= $_GET['id'] ?>">
                            </div>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card card-success">
                            ...
                            <div class="card-body pb-0" id="editar_sede">
                                ...
                                <div class="text-center">
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#changeLogo" class="btn btn-primary btn-sm mt-1">Cambiar Logo</button>
                                </div>
