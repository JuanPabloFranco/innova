<?php
session_start();
if (isset($_SESSION['datos']) && $_SESSION['datos'][0]->id_tipo_usuario <> 1) {
...
?>
    ...
    <input type="hidden" id="page" value="editarInfPersonal">
                ...
                <form id="form_avatar" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="input-group mb-3 mt-2">
                            ...
                            <input type="hidden" name="id_usuario" value="<?= $_SESSION['datos'][0]->id?>">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Cerrar</button>
                        ...
                        <div class="col-md-3">
                            <div class="card card-success card-outline">
                                <div class="card-body box-profile">
                                    ...
                                    <p class="text-muted text-center"><?= $_SESSION['datos'][0]->nombre_tipo; ?></p>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 text-center">
                                                            <hr><h4><b>Cuenta Bancaria</b></h4><hr>
                                                        </div>
                                                        <div class="col-sm-4">
                        ...
                        <form id="form_crear_persona_cargo">
                            <div class="card-body">
                                <div class="div form-group">
                                    ...
                                    <select name="tipo_lesion" id="selParentezcoPersona" class="form-control">
                                ...
                                <div class="div form-group">
                                    ...
                                    <input type="text" class="form-control" id="txtNombrePersona">
                                </div>
                                <div class="div form-group">
                                    <label for="txtFechaNacPersona">Fecha de Nacimiento</label>
                                    <input type="date" class="form-control" id="txtFechaNacPersona">
                                </div>
                            </div>
                            <div class="card-footer">
                                <button type="submit" class="btn bg-gradient-primary float-right m-1">Guardar</button>
