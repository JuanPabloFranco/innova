...
(3, 'Tecnico Sistemas', '', 1, 1, 1, 3),
(4, 'Tecnico Electronico', '', 1, 1, 1, 3),
(5, 'Ingeniero Software', '', 1, 1, 1, 12),
(6, 'Administrador Empresa','', 1, 1, 1, 3);
...
ALTER TABLE `usuarios` CHANGE `id_sede` `id_empresa` INT(2) NOT NULL;

ALTER TABLE `usuarios` CHANGE `direccion` `direccion` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL;
